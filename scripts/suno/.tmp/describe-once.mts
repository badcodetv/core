...
const R = process.cwd()
loadEnvFile(R)
const res = await describe({ path: process.argv[2], lens: process.argv[3] || "music", start: process.argv[4] || undefined, end: process.argv[5] || undefined, question: process.argv[6] || undefined } as any, {
