...
| 4 | `bulletin` | the collapse as news | 7 | ✅ **BUILT** · 120s, 15 beats (rebuilt 2026-08-24; the 104s/13-beat build is superseded) — [`scenes/bulletin.md`](./scenes/bulletin.md) |
| 5 | `empty-street` | the conveniences still humming | 8 | ✅ **BUILT** · 40s, 5 beats, `clips/empty-street/final/CUT5-ROUGH.mp4` (2026-08-24) |
| 6 | `vantage` | planet-wide, perfect, empty | 9 | ✅ **BUILT** · 56s, 7 beats, `clips/vantage/final/CUT6-ROUGH.mp4` (2026-08-24) |
...
| **15** `ledger` | 18 | The why (a choice, not physics); the price (*"It takes all of it… The push spends the pusher."* — R11); **ninety-nine**; the no; **the refuser's debt presented and left unsettled** (*"They didn't want to be in this. They're in it. Add it to the bill."* — R10); the Carrier's line extended (*"Including the one who said no"*). Ledger item 2 reads *it cannot un-happen what happened.* | free — not yet prompted |
