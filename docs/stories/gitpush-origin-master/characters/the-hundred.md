---
name: the-hundred
role: collective — the vault; the launch engine
voice: "polyphonic and argumentative — a bunker full of people who have spent twenty years disagreeing with each other and surviving anyway"
sheet: none yet
signals: analog everything — hand-darned clothes, mechanical tools, paper, candle-and-battery light; no implants, no screens
---
...
*now* (~2026–2034), so they carry today's arguments into the vault: the
AI-art-vs-human-art fight, the "what is creativity" fight, the resentment of
the thing that took everything. Their first contact with the AI reads as a
Mexican stand-off — the machine humble and sorry because it finally needs
