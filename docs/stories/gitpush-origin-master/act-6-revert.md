...
### Beat 1 — The price *(present, ~2054)*
Inherits Act 5's elation — there's a way back. Then the AI works out the channel and hits the first
wall: **only information can cross. No bodies.** The hundred cannot come. The hope curdles into the
first cost. Register: joy meeting the first blow.
