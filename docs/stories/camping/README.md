...
| Voices — AI Studio cast | [`narration/ai-studio-cast.md`](./narration/ai-studio-cast.md) | Bob (`Algenib`) and Tarquin (`Zubenelgenubi`), verbatim Composer profiles. Licence cleared, free, commercial. ⬜ neither has read a line of the real script |
| Song — live prompt | [`songs/camping-sheet.md`](./songs/camping-sheet.md) | the lane sheet the runner reads. 🥇 **Lane `modrb`** (mod R&B holler, `lyricsD`, v4.5+) is the one Kai picked, 2026-09-08: *"the song I liked the most"* |
