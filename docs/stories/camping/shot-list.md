# Camping — the edit order (shot list)

> **What this is:** every shot in the film, in the order it appears in the cut, one line each.
> It is the *assembly* view. [`story.md`](./story.md) stays the canon — if the two disagree,
> `story.md` wins, and its [storyboard section](./story.md#storyboard--scene-by-scene-video-guide)
> holds the actual framing, narration drafts and asset checklist.
>
...
- [x] **7a's foreground shoulder colour — resolved 2026-08-26.** The prompt says *dark*; the
      accepted frame is **pale**, which matches the oatmeal jumper in the 7b frames. **The
      picture beat the prompt.** 7a and 7b cut together. *(Read off the frame, not measured.)*
...
## Front-loaded backstory — 2008

*Nobody has met the story yet. The job of these three scenes is to make the audience judge both
men before the plot starts, so the rest of the film can dismantle it.*
...
- **5a The wank tank pulls away from the Shard** — night, gold headlights.
- **5b Through the glass** — homeless people on the streets of London.
- **5c Tarquin chuckles at his own joke** — *"rates up 1% next week, you lot'll have loads more mates."*
- **5d The hold — the smile fades.** No narration. Let it run; the face does everything.
- **5e The narrator lands the U-turn** — the one **spell-it-out** moment in the film. The empathy is cold, not guilt: his own car heater broke last week.

## The two men

- **6a The Waitrose car park** — first sight of the tent.
...
## ⏸ 8b — where it got to (2026-08-26)

**The decision: two singles, never a two-shot.** Two faces in one frame is the thing this film
has never attempted — 2b needed Veo 3.1 just to hold two faces through a laugh in a locked
interior, and 8b is a wet car park. One face per generation, each cast on its own Character.
**8c's judgement beats then reuse the same two setups**, so it is two stills for four shots.

**The angles carry the argument for free.** Bob is low in the tent, Tarquin is standing by his
car, so **Tarquin's single looks up at him and Bob's single looks down**. Same rain, opposite
power, no narration needed.

### What the plate's geometry settles

Measured off the 8a frame — tent, X8 and store positions:

- **The store sits about 38° right of the tent→car sightline**, which is outside a normal lens.
  Any Waitrose fascia behind Tarquin means the camera is wrong.
- **At a true one-metre lens height it could not be behind his head anyway.** A 4 m fascia at
  30 m projects ~6° above horizontal; his head at 4 m projects ~11°. The sign would land near
  his chest.
- **Straight past the X8 there is no building** — open bays, then the far row of parked cars low
  on the horizon, then sky.
- **The X8's nose points at the store and the tent is one bay to its right**, so on a UK car
  **the driver's door opens straight at the tent.** He steps out already facing Bob. Nothing to
  stage.

**The instruction that finally fixed the camera: _his head and shoulders are against nothing but
pale grey sky._** Writing "one metre off the ground" was ignored three times. Writing the
*consequences* — horizon at his hips, the underside of his jaw visible, the roofline above his
shoulder, sky behind his head — worked first time. **Write camera height as what it does, never
as a number.**

### ⚠️ The tent must stay a bottom edge

One round came back looking **out through the tent doorway** — a letterbox vignette. That is
**6c's locked framing**, which the film reserves for the 10a wake-up rhyme, and spending it here
...
- **A policy block cost one generation.** The suspects were *"nothing has been added over what he
  is wearing"* (clothing-removal shaped, in the rain, alone — trigger 5) and the appearance
  cluster *"fed and slightly worn rather than clean-cut and handsome / the beginning of a jowl /
  fine broken capillaries"* (derogatory description on a likeness). **Both cut, unrun, per the
  house posture: do not defend a clause you do not need.** It generated on the next attempt.
- **The wardrobe is now `@Tarquin-new`** — see
  [`characters/tarquin.md`](./characters/tarquin.md#-tarquin-new--the-leisure-character-2026-08-26).
  Four rounds of describing, referencing and saying nothing all returned a leather bomber and a
  printed t-shirt. It had to become a Character.

---

## Chains — shots that depend on other shots

Three places where a later shot is *made from* an earlier one. Break the chain and the device dies.
...
| **6c** Bob's tent POV | **10a** Tarquin's wake-up | Identical framing — door-flap letterbox, low horizon. Only the world outside changes. **✅ Locked 2026-08-26 by inheritance, not description**: 6c was generated from the scene-8 tent frame with only the view through the doorway changed, and 10a must be generated from 6c the same way. The foreground body becomes Tarquin's. |
