...
# Karen — the river drop

Prompts for one Act 1 beat: **Karen and Susan at the river, and the phone goes in.**
[`story.md`](./story.md#16-the-phone-in-the-river--keep-retake-till-the-physics-behave)
§1.6.

> ## 🖐 Why this is its own file
>
> [`prompts.md`](./prompts.md) is a **record** — prompts Jack typed into Flow by
> hand, kept verbatim as a restore point. This file is the opposite: a **brief**,
> written in-repo, unfired, and expected to change. Keeping the two apart means
> nothing here can be mistaken for a restore point, and revising it can never
> disturb the ledger.
>
> It inherits the ledger's conventions — the §1 `STYLE LOCK` at the top of every
> plate, the casting rule, no legible text anywhere, the closing *"Thanks."*
> Section numbers continue the ledger's sequence (§2g) so cross-references still
> read.
>
> **Engine research does not live here.** The Omni Flash findings this section
...
([§2e](./prompts.md#2e-the-new-york-walk-plates--super-8-register-not-yet-fired)), so this night
