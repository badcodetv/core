...
A New York middle manager, fired by an AI, weaponises the one thing she's great at —
complaining — and her "I want to speak to your manager" escalates from a Midtown
phone box to the President live on air, at the exact moment the AI fires him too.
A hundred years later, there's a statue.
...
- **The story structure** — locked 2026-08-05 in the master-notes session; the
  storyboard is the record.
- **The AI's name — Sean AI** (2026-07-22, register refined 2026-08-05: a screen,
  never a face).
- **Karen's surname — Bell** (from the song).
- **Release slot — EP1**, next up after Camping (2026-07-22).
