...
**Prompt (exact, sent to Flow — reconstructed from the v1 comic plan (now ./v1-comic-plan.md) house style + scene; flow_media_id unknown, predates per-panel records):**
