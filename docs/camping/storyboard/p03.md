...
**Bubbles:**
1. T "I wish I could be as ruthless as Tarquin." — x 20 · y 30 · type T · tail none · appearAt [0, 0.5]
2. T "Maybe then I'd get the promotion." — x 78 · y 35 · type T · tail none · appearAt [0.5, 1]

**Page:** hold 1.4 · transition: default (not overridden in §3) · effect: none.

**Revisions:**
- v0 (2026-07-25) — recut spec
- v4 (2026-07-28) — REWRITTEN bubbles (Kai review): dropped the spoken Q&A and the
  "Winning Mentality™" answer; the beat is now two onlooker *thought* bubbles
  (envy + promotion-hunger) — the applauders do the characterisation. hold
  1.8 → 1.4: the walking-out-to-applause stretch scrolled too long.
