...
| [The BadCode Robot](badcode-robot.md) | build the superintelligence out of the cheapest open-source parts — then load it a tune and it dances (ships with a BadCode original; give it your own) | music · video · software | seed |
