...
| [The BadCode Robot](badcode-robot.md) | build the superintelligence out of the cheapest open-source parts, then it dances to your tune — the build is the electronics lesson | video · music · software | seed |
