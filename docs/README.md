...
- [`cinematography/`](./cinematography/README.md) — the shot-craft toolkit (`shot-craft` skill): what a shot should BE, tool-agnostic — 26 graded principles, the symptom→cause→fix diagnostic, the frame, motion and cutting (incl. **the re-cut method**), the static frame, the registers and **the monumental/visible-cost gate**, the evidence ledger. Distilled from the 20-brief sweep in [`../design/research/2026-08-26-cinematography/`](../design/research/2026-08-26-cinematography/)
