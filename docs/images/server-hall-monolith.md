---
image: server-hall-monolith.jpg
flow_media_id: eb27d6ea-74ef-4d88-9bf1-415b2f4987d2
model: nano-banana-2
status: done
used_by:                       # not yet deployed
---

![server-hall-monolith](server-hall-monolith.jpg)

A variant of the register anchor (`docs/images/register-anchor.jpg`) with
