...
export function CampingComic() {
  return (
    <ScrollComic progressBar pageIndicator scrollHint pageDefaults={{ background: '#0a0f1c' }}>
      ...
      <Page hold={1.8} effect={zoom({ amount: 1.3 })} transition={null}>
        <AnimationWidget animation={comic.resolveAnimation('anim/a01')} />
      </Page>

      {/* 2 — Boardroom. Private equity: record profits, and where they came from. */}
      <Page hold={1.6}>
        <ImageWidget src={comic.resolve('img/i44.png')} />
        <SpeechBubble x={34.45} y={34.42} appearAt={[0, 0.5]} fade tail="none">
          {'As you can see, ladies and gentlemen — our profits this year are record-breaking.'}
        </SpeechBubble>
        <SpeechBubble x={30} y={62} appearAt={[0.5, 1]} fade tail="none">
          {'Largely thanks to one strategy: buying up all the residential housing stock.'}
        </SpeechBubble>
      </Page>

      {/* 3 — Lift lobby, applause. The onlookers' thoughts do the adoration. */}
      <Page hold={1.4}>
        <ImageWidget src={comic.resolve('img/i45.png')} />
        <SpeechBubble x={20} y={30} appearAt={[0, 0.5]} fade type="thought" tail="none">
          {'I wish I could be as ruthless as Tarquin.'}
        </SpeechBubble>
        <SpeechBubble x={78} y={35} appearAt={[0.5, 1]} fade type="thought" tail="none">
          {'Maybe then I\'d get the promotion.'}
        </SpeechBubble>
      </Page>

      {/* 4 — Lobby small talk on the way out. Two lines, straight to Wales. */}
      <Page hold={1.6}>
        <ImageWidget src={comic.resolve('img/i46.png')} />
        <SpeechBubble x={18.48} y={55.44} appearAt={[0, 0.45]} fade tail="none">
          {'What are you up to this weekend, mate?'}
        </SpeechBubble>
        <SpeechBubble x={60} y={22} appearAt={[0.4, 1]} fade tail="none">
          {'An ayahuasca retreat in Wales. I\'m curious about myself.'}
        </SpeechBubble>
      </Page>

      {/* 5 — The BMW pulls away toward Wales. No text: the shot is the line. */}
      <Page hold={2.8}>
      ...
      <Page hold={2} effect={zoom({ amount: 1.25, focal: [0.55, 0.3] })}>
        ...
        <SpeechBubble x={30} y={25} appearAt={[0, 0.45]} fade type="thought" tail="none">
          {'Two parking spaces. For that.'}
        </SpeechBubble>
        <SpeechBubble x={32} y={40} appearAt={[0.5, 0.9]} fade type="thought" tail="none">
      ...
      <Page hold={2}>
        ...
        <SpeechBubble x={69.9} y={47.15} appearAt={[0.1, 0.7]} fade type="thought" tail="none">
      ...
      <Page hold={2.2}>
        ...
        <SpeechBubble x={18.89} y={39.06} appearAt={[0.1, 0.8]} fade type="thought" tail="none">
      ...
      <Page hold={3}>
        ...
        <SpeechBubble x={63.55} y={22.29} appearAt={[0, 0.35]} fade tail="none">
          {'I\'m Moonwhisper Ascending. I am here to cleanse my soul, also to do research for my new book called "The Wound That Teaches."'}
        </SpeechBubble>
        <SpeechBubble x={44} y={40} appearAt={[0.35, 0.68]} fade type="thought" tail="none">
        ...
        <SpeechBubble x={26} y={86} appearAt={[0.68, 1]} fade tail="none">
      ...
      <Page hold={1.8} effect={trip()}>
        ...
        <SpeechBubble x={15.47} y={75.02} appearAt={[0.1, 0.8]} fade type="thought" tail="none">
      ...
      <Page hold={3.2} effect={trip()}>
        ...
        <NarrationBox x={78} y={88} appearAt={[0.8, 1]} fade>
          {'Let\'s circle back.'}
        </NarrationBox>
      </Page>
      ...
      <Page hold={2.2} transition={null}>
        ...
        <SpeechBubble x={25} y={20} appearAt={[0.5, 1]} fade type="thought" tail="none">
      ...
      <Page hold={2}>
        ...
        <SpeechBubble x={52.68} y={21.39} appearAt={[0.1, 0.5]} fade type="thought" tail="none">
          {'I said a chimp could do it.'}
        </SpeechBubble>
        <SpeechBubble x={30} y={35} appearAt={[0.55, 1]} fade type="thought" tail="none">
      ...
      <Page hold={2.8}>
        ...
        <SpeechBubble x={17.89} y={24.98} appearAt={[0, 0.35]} fade tail="none">
          {'Cold ain\'t it? Haven\'t seen you in some time.'}
        </SpeechBubble>
        <SpeechBubble x={15.64} y={45.81} appearAt={[0.35, 0.65]} fade tail="none">
          {'You parked next to me once, I think. Big black thing. Took two spaces.'}
        </SpeechBubble>
        <SpeechBubble x={80.69} y={34.57} appearAt={[0.65, 1]} fade tail="none">
      ...
      <Page hold={2.4}>
        ...
        <SpeechBubble x={15.64} y={55.24} appearAt={[0, 0.5]} fade tail="none">
          {'Don\'t show weakness — they can smell it. Blade under your pillow. This ain\'t Eton.'}
        </SpeechBubble>
        <SpeechBubble x={75} y={30} appearAt={[0.6, 1]} fade type="thought" tail="none">
